...
type BuiltinPage = 'chat' | 'workbench' | 'models' | 'modules-manager' | 'settings'
...
const BUILTIN_NAV: { id: BuiltinPage; icon: string; label: string }[] = [
  ...
  { id: 'modules-manager', icon: '🧩', label: '模块' },
  { id: 'settings',        icon: '⚙️', label: '设置' },
]

const BUILTIN_TITLES: Record<BuiltinPage, string> = {
  chat: '对话', workbench: '工作台', models: '模型管理', 'modules-manager': '模块管理', settings: '设置',
}
